document.addEventListener('DOMContentLoaded', () => {
    ...
    region_comuna.regiones.forEach(region => {
        ...
        option.value = region.numero; // Usamos el número de la región como valor
        option.textContent = region.nombre;
        regionSelect.appendChild(option);
    });

    // Listener para cargar las comunas cuando se selecciona una región
    regionSelect.addEventListener('change', () => {
        const regionId = regionSelect.value;
        cargarComunas(regionId);
    });

    // Función para cargar las comunas dependiendo de la región seleccionada
    function cargarComunas(regionId) {
        ...
        // Buscar la región seleccionada por su número
        const regionSeleccionada = region_comuna.regiones.find(region => region.numero == regionId);
